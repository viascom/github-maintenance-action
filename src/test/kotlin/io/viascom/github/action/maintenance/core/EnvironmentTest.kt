 ...
 * 
 * This test doesn't rely on the Environment singleton, but instead tests the validation logic directly.
 * This approach is similar to EnvironmentValidationTest but kept separate for clarity.
 */
